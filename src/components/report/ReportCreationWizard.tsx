...
export function ReportCreationWizard() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <Step2TemplateSelection selectedTemplate={selectedTemplate} onSelectTemplate={setSelectedTemplate} />;
      case 3:
    ...
    <div className="space-y-8">
      ...
      <div className="flex justify-between items-center">
        ...
        {currentStep < steps.length ? (
          <Button onClick={goToNext} disabled={(currentStep === 2 && !selectedTemplate) || isPending}>
            {isPending ? "..." : "Next"}
          </Button>
        ) : <div />}
      </div>
